...
The saved map passed a fresh native-editor reload with 1804 actors and 244 materials. Saved texture pixels were compared against 244 source/baked images. 28 effect actors passed saved-material and collision-flag checks. Native collision probes produced 85 hits from 1014 traces, with maximum cache index 3985 (below 5000). Source-normal comparison mean dot: 0.880. These checks do not replace rendered review or in-game playtesting.
