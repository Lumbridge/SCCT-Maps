...
The saved map passed a fresh native-editor reload with 509 actors and 179 materials. Saved texture pixels were compared against 179 source/baked images. 82 effect actors passed saved-material and collision-flag checks. Native collision probes produced 465 hits from 1014 traces, with maximum cache index 2640 (below 5000). Source-normal comparison mean dot: 0.890. These checks do not replace rendered review or in-game playtesting.
