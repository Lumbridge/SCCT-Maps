...
The saved map passed a fresh native-editor reload with 398 actors and 148 materials. Saved texture pixels were compared against 148 source/baked images. 0 effect actors passed saved-material and collision-flag checks. Native collision probes produced 13 hits from 1014 traces, with maximum cache index 3859 (below 5000). Source-normal comparison mean dot: 0.898. These checks do not replace rendered review or in-game playtesting.
