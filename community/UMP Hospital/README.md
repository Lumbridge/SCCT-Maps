...
Original compiled community-pack map: `UMPMHCLASSIC.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Echelon`, `SGameplayObjectsTex`, `TestMapStaticM`, `txt_war`.
