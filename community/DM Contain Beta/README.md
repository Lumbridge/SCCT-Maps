...
Original compiled community-pack map: `dm_contain.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Dep`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `FAC_STM`, `GAR_STM`, `GAR_TXT`, `STM_MALL`, `TXT_BNK`, `amb_Bank`, `sfx`, `stm_war`, `txt_war`.
