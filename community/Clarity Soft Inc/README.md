...
Original compiled community-pack map: `CSI01.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Dep`, `Amb_Museum`, `Amb_Orph`, `Amb_Tme`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `GAR_STM`, `GAR_TXT`, `Missile`, `SGameplayObjectsTex_led`, `SHudTextures`, `STM_MALL`, `STM_ORP`, `TME01_STM`, `TXT_BNK`, `TXT_ORP`, `TestMapStaticM`, `sfx`, `stm_war`, `txt_war`.
