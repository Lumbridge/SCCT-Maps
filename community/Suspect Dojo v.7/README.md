...
Original compiled community-pack map: `USDOJO.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Dep`, `Amb_Orph`, `Aquarium_STM`, `CLU04_STM`, `CLU04_TXT`, `STM_MALL`, `stm_war`, `txt_war`.
