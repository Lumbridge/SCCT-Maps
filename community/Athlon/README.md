...
Original compiled community-pack map: `ATH05.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Aquarium_STM`, `Aquarium_TXT`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `GAR_STM`, `Mall_tibu`, `Mall_tibu_stc`, `Missile`, `STM_ORP`, `Sound_Persos`, `TME01_STM`, `TestMapStaticM`, `amb_Bank`, `sfx`, `stm_war`, `txt_war`.
