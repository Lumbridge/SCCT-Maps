...
Original compiled community-pack map: `DIM01.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Aquarium_STM`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `stm_war`.
