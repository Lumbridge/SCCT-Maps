...
Original compiled community-pack map: `NNY02.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Club`, `Amb_Dep`, `Amb_Orph`, `Amb_Tsp`, `Aquarium_STM`, `Armes_impacts`, `CLU04_TXT`, `Echelon`, `STM_ORP`, `TXT_MAL`, `TXT_ORP`, `TestMapStaticM`, `nd133`, `sfx`, `stm_war`.
