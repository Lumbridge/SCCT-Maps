...
Original compiled community-pack map: `MUS08b.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Museum`, `Aquarium_TXT`, `Armes_impacts`, `Echelon`, `TestMapStaticM`, `sfx`, `stm_war`.
