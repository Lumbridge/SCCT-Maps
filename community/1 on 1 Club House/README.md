...
Original compiled community-pack map: `c1v1esl.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Club`, `Amb_Miss`, `Amb_Museum`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `Interface`, `Missile`, `Sound_Persos`, `amb_Bank`, `sfx`.
