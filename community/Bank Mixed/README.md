...
Original compiled community-pack map: `BNK11b.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Armes_impacts`, `BNK_STM`, `TXT_BNK`, `TestMapStaticM`, `amb_Bank`, `sfx`, `stm_war`.
