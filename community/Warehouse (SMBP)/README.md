...
Original compiled community-pack map: `WAREXT.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Dep`, `Amb_Orph`, `Armes_impacts`, `CTF_static`, `TestMapStaticM`, `stm_war`, `txt_war`.
