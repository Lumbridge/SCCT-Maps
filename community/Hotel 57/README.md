...
Original compiled community-pack map: `Hotel2.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Gare`, `Amb_Miss`, `Amb_Museum`, `Amb_Orph`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `GAR_STM`, `Mall_tibu`, `Mall_tibu_stc`, `Missile`, `SGameplayObjectsTex`, `SHudTextures`, `STM_MALL`, `STM_ORP`, `TSP01_STM`, `TXT_BNK`, `TXT_ORP`, `TestMapStaticM`, `sfx`, `stm_war`, `txt_war`.
