...
Original compiled community-pack map: `BuddhistTemple.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Club`, `Amb_Gare`, `Aquarium_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `GAR_TXT`, `Mall_tibu`, `Mall_tibu_stc`, `STM_MALL`, `sfx`.
