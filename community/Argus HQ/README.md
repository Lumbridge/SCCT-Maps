...
Original compiled community-pack map: `AHQ06.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Club`, `Amb_Dep`, `Amb_Miss`, `Amb_Tme`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `FAC_STM`, `GAR_STM`, `GAR_TXT`, `Mall_tibu`, `SEffectStatic`, `SPersoTextures`, `SPersoTextures_ps2`, `Sound_Persos`, `TME01_STM`, `TSP01_STM`, `TXT_BNK`, `TXT_ORP`, `sfx`, `stm_war`, `txt_war`.
