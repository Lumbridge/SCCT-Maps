...
Original compiled community-pack map: `sub18.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Gare`, `Amb_Tme`, `Amb_Tsp`, `Amb_factory`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `EditorTex`, `FAC_STM`, `FAC_TXT`, `GAR_STM`, `GAR_TXT`, `Missile`, `SGameplayObjectsTex`, `STM_MALL`, `SWeaponTex`, `TME01_STM`, `TXT_BNK`, `TXT_MAL`, `TXT_ORP`, `TestMapStaticM`, `sfx`, `stm_war`, `txt_war`.
