...
Original compiled community-pack map: `CRY01.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Dep`, `Amb_Gare`, `Amb_Miss`, `Amb_factory`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_TXT`, `FAC_STM`, `FAC_TXT`, `GAR_TXT`, `Missile`, `STM_ORP`, `TXT_BNK`, `TXT_MAL`, `TXT_ORP`, `TestMapStaticM`, `sfx`, `stm_war`, `txt_war`.
