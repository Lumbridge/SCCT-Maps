...
Original compiled community-pack map: `SQU13.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Aquarium_TXT`, `Armes_impacts`, `Mall_tibu`, `sfx`.
