...
Original compiled community-pack map: `panama02.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Dep`, `Amb_Miss`, `Aquarium_STM`, `Aquarium_TXT`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `GAR_STM`, `Mall_tibu`, `Mall_tibu_stc`, `SGameplayObjectsTex`, `STM_MALL`, `STM_ORP`, `TXT_BNK`, `TXT_MAL`, `TXT_ORP`, `stm_war`, `txt_war`.
