...
Original compiled community-pack map: `ARG01.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Miss`, `Amb_Museum`, `Amb_Orph`, `Amb_factory`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `FAC_STM`, `FAC_TXT`, `GAR_STM`, `GAR_TXT`, `Mall_tibu`, `Mall_tibu_stc`, `Missile`, `STM_MALL`, `STM_ORP`, `TXT_BNK`, `TXT_MAL`, `TXT_ORP`, `TestMapStaticM`, `amb_Bank`, `sfx`, `stm_war`, `txt_war`.
