...
Original compiled community-pack map: `CHU01.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Orph`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `Echelon`, `FAC_STM`, `GAR_STM`, `Mall_tibu`, `STM_MALL`, `STM_ORP`, `TXT_BNK`, `TXT_ORP`, `sfx`, `stm_war`.
