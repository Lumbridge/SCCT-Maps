...
Original compiled community-pack map: `OIL33.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Gare`, `Amb_factory`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `Echelon`, `FAC_STM`, `FAC_TXT`, `GAR_STM`, `GAR_TXT`, `Missile`, `STM_ORP`, `TestMapStaticM`, `amb_Bank`, `sfx`, `stm_war`, `txt_war`.
