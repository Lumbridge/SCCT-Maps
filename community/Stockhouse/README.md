...
Original compiled community-pack map: `STH02.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Dep`, `Amb_Gare`, `Amb_Museum`, `Amb_Orph`, `Amb_Tme`, `Amb_Tsp`, `Amb_factory`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `FAC_STM`, `GAR_STM`, `GAR_TXT`, `Mall_tibu`, `Mall_tibu_stc`, `Missile`, `SGameplayObjectsTex`, `STM_MALL`, `STM_ORP`, `STM_Poc_AquaTest`, `TME01_STM`, `TSP01_STM`, `TXT_BNK`, `TXT_MAL`, `TXT_ORP`, `TestMapStaticM`, `Tutorials_PC`, `sfx`, `stm_war`, `txt_war`.
