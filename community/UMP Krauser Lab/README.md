...
Original compiled community-pack map: `UMPKRA07.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Gare`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `Echelon`, `GAR_STM`, `SGoggleTextures`, `TestMapStaticM`, `stm_war`.
