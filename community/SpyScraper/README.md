...
Original compiled community-pack map: `spyscraper.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Museum`, `Amb_Tsp`, `Aquarium_STM`, `Aquarium_TXT`, `Echelon`, `GAR_TXT`, `TestMapStaticM`, `stm_war`, `txt_war`.
