...
Original compiled community-pack map: `Horizon.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Dep`, `Amb_Gare`, `Amb_Miss`, `Amb_factory`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `FAC_STM`, `GAR_STM`, `Mall_tibu`, `Mall_tibu_stc`, `Missile`, `SGameplayObjectsTex`, `TXT_MAL`, `sfx`, `stm_war`, `txt_war`.
