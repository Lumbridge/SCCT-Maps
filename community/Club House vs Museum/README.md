...
Original compiled community-pack map: `museumvsclubhouse.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Club`, `Amb_Museum`, `Armes_impacts`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `Missile`, `TestMapStaticM`, `sfx`.
