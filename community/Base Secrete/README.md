...
Original compiled community-pack map: `RED1.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Orph`, `Aquarium_STM`, `Aquarium_TXT`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `FAC_STM`, `GAR_STM`, `GAR_TXT`, `Mall_tibu`, `Mall_tibu_stc`, `Missile`, `STM_MALL`, `STM_ORP`, `TXT_ORP`, `sfx`.
