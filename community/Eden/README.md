...
Original compiled community-pack map: `EDE64.sdc`. Original authorship and embedded credits are preserved. No editable conversion is included.
...
`Amb_Aqua`, `Amb_Club`, `Amb_Gare`, `Amb_Miss`, `Amb_Orph`, `Amb_Tsp`, `Amb_factory`, `Aquarium_STM`, `Aquarium_TXT`, `Armes_impacts`, `BNK_STM`, `CLU04_STM`, `CLU04_TXT`, `Echelon`, `FAC_STM`, `FAC_TXT`, `GAR_STM`, `GAR_TXT`, `Mall_tibu`, `Mall_tibu_stc`, `Missile`, `SEffectStatic`, `SPersoTextures`, `SPersoTextures_ps2`, `STM_MALL`, `STM_ORP`, `Sound_Persos`, `TME01_STM`, `TSP01_STM`, `TXT_BNK`, `TXT_MAL`, `TXT_ORP`, `TestMapStaticM`, `sfx`, `stm_war`, `txt_war`.
